...
*Unfortunately, I never developed the muscle memory to use this. See above.*
#+BEGIN_SRC emacs-lisp :tangle no
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Unfortunately, I don't use org mode enough yet, so the following
  ;; is uncommented for now.
