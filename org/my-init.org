...
*** GUI Hydra
    ...
    GUI elements (e.g. theme and font).
...
*** Custom symbols
  ...
  (with-eval-after-load 'latex
    ...
    (my-define-latex-keys LaTeX-mode-map "C-|" "\\biggl| ? \\biggr|")
    )
  ...
  (with-eval-after-load 'plain-tex
    ...
    (my-define-latex-keys plain-TeX-mode-map "C-|" "\\biggl| ? \\biggr|")
  )
    #+END_SRC
...
* CMake Support
  #+BEGIN_SRC emacs-lisp
    ...
    (defun my-cmake-common-hook ()
        (setup-yasnippet-next-key (kbd "TAB")))


    (autoload 'cmake-font-lock-activate "cmake-font-lock" nil t)
    (add-hook 'cmake-mode-hook 'cmake-font-lock-activate)
    (add-hook 'cmake-mode-hook #'my-cmake-common-hook)
  #+END_SRC
