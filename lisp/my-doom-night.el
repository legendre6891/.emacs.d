;;; doom-my-night-theme.el
(require 'doom-themes)

(defgroup doom-my-night-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-my-night-padded-modeline nil
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-my-night-theme
  :type '(or integer boolean))

(def-doom-theme doom-my-night
  ...
  ((bg         '("#1d1f21" nil       nil          ))
   ...
   (-modeline-pad
    (when doom-my-night-padded-modeline
      (if (integerp doom-my-night-padded-modeline)
          doom-my-night-padded-modeline
        4))))
...
(provide 'doom-my-night-theme)
;;; doom-my-night-theme.el ends here